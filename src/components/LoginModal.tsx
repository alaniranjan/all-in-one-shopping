          ...
          {clicked ? (
            <>
              ...
              <p className="leading-4">
                ...
                suited backend has been used here. Please use <b>niranjan@gmail.com</b> as
                username & <b>niranjan</b> as password. You can find these
              ...
              <form onSubmit={submitForm} className="flex flex-col space-y-3">
                <div className="relative">
                  <input
                    ...
                    type="text"
                    placeholder="Your username here... (niranjan@gmail.com)"
                ...
                <div className="relative">
                  <input
                    ...
                    type="password"
                    placeholder="Your password here... (niranjan)"
                    className="border w-full border-black py-2 px-8 rounded dark:bg-slate-600"
                  />
